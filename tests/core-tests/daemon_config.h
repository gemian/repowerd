...
class FakeAudioHeadphoneCS;
class FakeAudioKeepAlive;
...
public:
    ...
    std::shared_ptr<FakeLock> the_fake_lock();
    ...
    std::shared_ptr<FakeAudioHeadphoneCS> the_fake_audio_headphone_cs();
    std::shared_ptr<FakeAudioKeepAlive> the_fake_audio_keep_alive();
...
private:
    ...
    std::shared_ptr<FakeLock> fake_lock;
    ...
    std::shared_ptr<FakeAudioHeadphoneCS> fake_audio_headphone_cs;
    std::shared_ptr<FakeAudioKeepAlive> fake_audio_keep_alive;
